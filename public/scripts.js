async function windowActions() {
  ...
  form.addEventListener('keyup', async (event) => {
    ...
    restaurantDisplay.forEach((item) => {
      ...
      const restauranthtml = restaurantDisplay.map((place) => (`
             <li>
      ...
      targetList.innerHTML = restauranthtml.join('');
    });
  ...
  form.addEventListener('keyup', async (event) => {
    ...
    monumentsDisplay.forEach((item) => {
      const appendItem = document.createElement('li');
      const monumentshtml = monumentsDisplay.map((place) => (`
              <li>
      ...
      targetList.innerHTML = '';
      targetList.innerHTML = monumentshtml.join('');
    });
